...
class SendCodeViewModel(val context: Context) : ViewModel() {
                ...
                when (response.code()) {
                    ...
                    400 -> {
                        _dialogMessage.postValue(
                            context.getText(R.string.login_with_google).toString()
                        )
                    }

                    404 -> {
                        _dialogMessage.postValue(
                            context.getText(R.string.email_not_found).toString()
                        )
                        ...
                        _dialogMessage.postValue(
                            context.getText(R.string.error_try_again).toString()
                        )
                    }
